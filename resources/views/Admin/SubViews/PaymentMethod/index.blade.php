                        ...
                        <table class="table table-striped table-head-custom table-checkable" id="dtTable">
                            ...
                            <tbody id="add-row">
                                @foreach ($paymentMethods as $paymentMethod)
                                    <tr id="sid{{ $paymentMethod->id }}">
                                        <td><span class="badge rounded-pill badge-light-primary">{{ $paymentMethod->id }}</span>
                                        </td>
                                            ...
                                            <div class="d-flex flex-column align-items-center">
                                                <div class="form-check form-switch form-check-primary">
                                                    <input type="checkbox" class="form-check-input" name="changeStatus"
                                                        id="{{ $paymentMethod->id }}"
                                                        {{ $paymentMethod->deleted_at ? null : 'checked=checked' }} />
                                                </div>
                                            </div>
                                        </td>
                                        <td><span
                                                class="badge rounded-pill badge-light-secondary">{{ $paymentMethod->created_at }}</span>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm" type="button" data-bs-toggle="modal"
                                                ...
                                                id="edit-button" data-id="{{ $paymentMethod->id }}">
                                            ...
                                            {{-- <a href="javascript:;" class="btnDelete" id={{ $paymentMethod->id }}
