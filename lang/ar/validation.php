...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'car_number_plate'      => 'رقم لوحة السيارة',
        'region'                => 'المنطقة',
        'street'                => 'الشارع',
        'lat'                   => 'خط العرض',
        'lng'                   => 'خط الطول',
        ...
        'name_en'               => 'الأسم بالأجنبي',
        'region_id'             => 'المنطقة',
        'privacy_policy_ar'     => 'سياسة الخصوصية بالعربي',
        'privacy_policy_en'     => 'سياسة الخصوصية بالأجنبي',
        'terms_conditions_ar'   => 'الشروط والأحكام بالعربي',
        'terms_conditions_en'   => 'الشروط والأحكام بالأجنبي',
        'about_us_ar'           => 'معلومات عنا بالعربي',
        'about_us_en'           => 'معلومات عنا بالأجنبي',
        'title_ar'              => 'العنوان بالعربي',
        'title_en'              => 'العنوان بالأجنبي',
        'text_ar'               => 'الوصف بالعربي',
        'text_en'               => 'الوصف بالأجنبي',
        'brand_ar'              => 'البراند بالعربي',
        'brand_en'              => 'البراند بالأجنبي',
        'distance_range_in_km'  => 'نصف قطر الدائرة',
        'price_in_km'           => 'السعر بالكيلو متر',
        'has_detail'            => 'لديه تفاصيل',
        'payment_method'        => 'طريقة الدفع',
        'payment_method_id'     => 'طريقة الدفع',
        'commercial_register'   => 'رقم السجل التجاري',
        'tax_number'            => 'الرقم الضريبي',
        'previous_jobs'         => 'الأعمال السابقة',
        'files.*.name'          => 'اسم الملف',
        'contract_value'        => 'قيمة القعد',
        'contract_date'         => 'تاريخ القعد',
        'expiry_date'           => 'مدة الضمان',
        'file'                  => 'الملف',
        'invoice_id'            => 'الفاتورة',
