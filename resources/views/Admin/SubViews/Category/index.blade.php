                            ...
                            <tbody id="add-row">
                                @foreach ($categories as $category)
                                    <tr id="sid{{ $category->id }}">
                                        <td><span class="badge rounded-pill badge-light-primary">{{ $category->id }}</span>
                                        </td>
                                        <td><img src="{{ $category->image }}" alt="category image"
                                                style="width:75px;height:75px;"></td>
                                        <td>{{ $category->name }}</td>
                                        <td>{{ $category->services()->count() }}</td>
                                        <td>{{ $category->services()->withCount('orders')->get()->sum('orders_count') }}
                                        </td>
                                        <td>{{ $category->services()->min('price') . ' - ' . $category->services()->max('price') }}</td>
                                        <td>
                                            <div class="d-flex flex-column align-items-center">
                                                <div class="form-check form-switch form-check-primary">
                                                    <input type="checkbox" class="form-check-input" name="changeStatus"
                                                        id="{{ $category->id }}"
                                                        {{ $category->deleted_at ? null : 'checked=checked' }} />
                                                </div>
                                            </div>
                                        </td>
                                        <td><span
                                                class="badge rounded-pill badge-light-secondary">{{ $category->created_at }}</span>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm" type="button" data-bs-toggle="modal"
                                                ...
                                                id="edit-button" data-id="{{ $category->id }}">
                                            ...
                                            <a href="javascript:;" class="btnDelete" id={{ $category->id }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img id="show_image" src="#"
                                            style="display:none;width:150px;height:150px;" alt="category image" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    if (xhr.status == 201) {
                        ...
                        $('#add-row').prepend(`
                            <tr id="sid${response.data.id}">
                                ...
                                <td><img src="${response.data.image}" alt="category image" style="width:75px;height:75px;"></td>
            ...
            $.ajax({
                ...
                success: function(response, textStatus, xhr) {
                    ...
                    $('#sid' + response.data.id).find("td").eq(1).html(
                        `<img src="${response.data.image}" alt="category image" style="width:75px;height:75px;">`
                    );
                    $('#sid' + response.data.id).find("td").eq(2).html(response.data.name);
