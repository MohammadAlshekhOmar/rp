                ...
                <div class="modal-body flex-grow-1">
                            ...
                            <div class="mb-1">
                                ...
                                <select class="form-control" name="language_id">
                                    ...
                                    @foreach ($languages as $language)
                                        <option {{ $language->id == $user->language_id ? 'selected' : null }}
                            ...
                            <div class="mb-1">
                                ...
                                <select class="select2 form-control" name="region_id">
                                    ...
                                    @foreach ($regions as $region)
                                        <option {{ $region->id == $user->region_id ? 'selected' : null }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <img id="show_image" src="{{ $user->image }}"
                                style="width:200px;height:200px;margin:20px;" alt="user image" />
                        </div>
                    </div>
                </div>
