                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="row">
                            ...
                            <div class="mb-1">
                                ...
                                <select class="select2 form-control" name="role_id">
                                    ...
                                    @foreach ($roles as $role)
                                        <option {{ $admin->roles()->first()?->name == $role->name ? 'selected' : null }}
                        ...
                        <div class="col-md-6">
                            ...
                            <img id="show_image" src="{{ $admin->getFirstMediaUrl('Admin') }}"
                                style="width:200px;height:200px;margin:20px;" alt="admin image" />
                        </div>
                    </div>
                </div>
