                        ...
                        <table class="table table-striped table-head-custom table-checkable" id="dtTable">
                            ...
                            <tbody id="add-row">
                                @foreach ($serviceRates as $serviceRate)
                                    <tr id="sid{{ $serviceRate->id }}">
                                        <td><span class="badge rounded-pill badge-light-primary">{{ $serviceRate->id }}</span>
                                        </td>
                                        <td>{{ $serviceRate->user?->name }}</td>
                                        <td>{{ $serviceRate->rate }}</td>
                                        <td>{{ $serviceRate->text }}</td>
                                        <td><span
                                                class="badge rounded-pill badge-light-secondary">{{ $serviceRate->created_at }}</span>
                                        </td>
                                        <td>
                                            <a href="javascript:;" class="btnDelete" id={{ $serviceRate->id }}
